        ...
        <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12 items-center">
                <div className="text-center md:text-left">
                    <h3 className="text-[clamp(1.8rem,3vw,2.5rem)] font-black mb-2 bg-clip-text text-transparent bg-gradient-to-r from-[#8b34c2] to-white">
                        WHITE RABBIT HOLE
                    </h3>
                    <p className="text-xl text-white/80 font-semibold">Powered by ADHD</p>
                </div>
